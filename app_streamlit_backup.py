...
with st.sidebar:
    ...
    theme_label = "🌙 Imperial Dark" if st.session_state.theme == "dark" else "☀️ Corporate Light"
...
THEMES = {
    "dark": {
        ...
        "card_border": "#334155",
        "accent": "#FBBF24",
        "accent_dim": "rgba(251, 191, 36, 0.1)",
        "sidebar_bg": "#0F172A",
        "header_grad": "linear-gradient(135deg, #1E293B, #0F172A)",
        "tab_bg": "#1E293B",
        "tab_text": "#94A3B8",
        "tab_active": "#8B5CF6",
        "bg_img": "data/assets/dark_bg.png"
    },
    "light": {
        "bg": "#F8FAFC",
        "text": "#1E293B",
        ...
        "card_border": "#E2E8F0",
        "accent": "#4F46E5",
        "accent_dim": "rgba(79, 70, 229, 0.1)",
        "sidebar_bg": "#F1F5F9",
        "header_grad": "linear-gradient(135deg, #4F46E5, #3730A3)",
        "tab_bg": "#FFFFFF",
        "tab_text": "#64748B",
        "tab_active": "#4F46E5",
        "bg_img": "data/assets/light_bg.png"
    }
}
...
bg_base64 = get_base64_bin(t['bg_img'])
...
<style>
    ...
    * {{ font-family: 'Source Sans 3', sans-serif; }}
    ...
    /* Overlay to ensure readability over bg image */
    .stApp::before {{
        content: "";
        position: fixed;
        top: 0; left: 0; width: 100%; height: 100%;
        background: {t['accent_dim'] if st.session_state.theme == 'light' else 'rgba(15, 23, 42, 0.85)'};
        z-index: -1;
    }}
    ...
    .main-header h1 {{
        ...
        background: linear-gradient(90deg, #FFFFFF, {t['accent']});
    ...
    .metric-card h3 {{ color: {t['tab_text']}; font-size: 0.8rem; text-transform: uppercase; }}
    .metric-card .value {{ color: {t['text']}; font-size: 2.2rem; font-weight: 700; }}
